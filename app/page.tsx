  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <Link href="https://wa.me/6285724224946?text=Hai%20Website%20PRO,%20saya%20ingin%20membuat%20website" target="_blank">
          ...
          <Card key={index} className={`border border-border hover:shadow-md transition-shadow ${type.bgColor}`}>
            ...
            {type.features.map((feature) => (
              <li key={feature} className="flex items-center gap-2">
                ...
                <Link href={`https://wa.me/6285724224946?text=Hai%20Website%20PRO,%20saya%20ingin%20membuat%20website%20${type.title}`}>
        ...
        <section className="py-16 sm:py-24 bg-primary text-primary-foreground">
         ...
         <section className="py-16 sm:py-24 bg-gray-100">
          <div className="container px-4 mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-center mb-12">Contoh Portofolio Kami</h2>
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              {[
                {
                  title: "Narros",
                  description: "Website Comunity motor ngalcer di kota Bandung",
                  image: "/assets/project1.png",
                  link: "https://narros.fun",
                },
                {
                  title: "PEDE OFFICIAL",
                  description: "Media Dakwah PD Pemuda Persis Kab Bandung",
                  image: "/assets/project2.png",
                  link: "https://pedeofficial.org",
                },
                {
                  title: "MUFEED Outfit",
                  description: "Outfit Muslim Anak Masa kini tampil islami, tetap aktif dan ceria!",
                  image: "/assets/project3.png",
                  link: "https://mufeed.id",
                },
                {
                  title: "Masjid Annur Katapang",
                  description: "website resmi Masjid Annur Lebakmuncang di daerak Katapang Kab Bandung",
                  image: "/assets/project4.png",
                  link: "https://masjidannurlebakmuncang.com/",
                },
              ].map((project, index) => (
                <Card key={index} className="border border-border hover:shadow-md transition-shadow">
                  ...
                  <Link href={project.link} target="_blank">
                    <Button className="notion-button w-full mt-4">
                    Akses Website
                    </Button>
                  </Link>
                  </CardContent>
